...
namespace MAUISampleApp.Platforms.iOS.Handlers
{
    public class HybridWebViewHandler : ViewHandler<IHybridWebView, WKWebView>
    {
        ...
        const string JavaScriptFunction = "function invokeNativeAction(data){window.webkit.messageHandlers.invokeAction.postMessage(data);}";
